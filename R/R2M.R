...
#'     }
#'   \item{m1}{Selected mediators in subsample 1.}
#'   \item{m2}{Selected mediators in subsample 2.}
#' }
#'
#'
...
#' @examples
#' data(exampleData)
#' R2M(Y=exampleData$study4$Y, M=exampleData$study4[, 3:52], X=exampleData$study4$X, FDR=FALSE)
